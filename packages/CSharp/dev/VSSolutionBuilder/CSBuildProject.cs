...
namespace VSSolutionBuilder
{
        ...
        ICSProject
    {
            ...
            Opus.Core.ProxyModulePath proxyPath)
        {
            ...
            var isPackageDirAbsolute = Opus.Core.RelativePathUtilities.IsPathAbsolute(packagePath);
        ...
        IProject.Serialize()
        {
            ...
            try
            {
                    ...
                    (this.PageFiles.Count > 0))
                {
                    ...
                    if (this.ApplicationDefinitionFile != null)
                    {
                        var xamlRelativePath = Opus.Core.RelativePathUtilities.GetPath(this.ApplicationDefinitionFile.RelativePath, projectLocationUri);
                    ...
                    {
                        var xamlRelativePath = Opus.Core.RelativePathUtilities.GetPath(pageFile.RelativePath, projectLocationUri);
