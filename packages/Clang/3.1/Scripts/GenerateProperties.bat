...
%OPUS_DIR%\OpusOptionInterfacePropertyGenerator -i=%OPUS_PACKAGE_DIR%\C\dev\Scripts\ICCompilerOptions.cs -o=CCompilerOptionProperties.cs -n=Clang -c=CCompilerOptionCollection
IF NOT ERRORLEVEL 0 GOTO error

REM C++ compiler option properties
%OPUS_DIR%\OpusOptionInterfacePropertyGenerator -i=%OPUS_PACKAGE_DIR%\C\dev\Scripts\ICPlusPlusCompilerOptions.cs -o=CxxCompilerOptionProperties.cs -n=Clang -c=CxxCompilerOptionCollection
IF NOT ERRORLEVEL 0 GOTO error
