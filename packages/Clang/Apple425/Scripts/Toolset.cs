...
namespace Clang
{
        ...
        XcodeBuilder.IXcodeDetails
    {
        ...
        Toolset() : base()
        {
            ...
            this.toolConfig[typeof(C.IObjCxxCompilerTool)] = new Bam.Core.ToolAndOptionType(new ClangCommon.CxxCompiler(this), typeof(ObjCxxCompilerOptionCollectionDelegates.csObjCxxCompilerOptionCollection));
