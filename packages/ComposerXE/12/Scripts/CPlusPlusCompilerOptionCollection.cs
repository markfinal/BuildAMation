...
namespace Intel
{
    // this implementation is here because the specific version of the Intel compiler exposes a new interface
    ...
    public sealed partial class CPlusPlusCompilerOptionCollection : CCompilerOptionCollection, C.ICPlusPlusCompilerOptions
    {
        ...
        protected override void InitializeDefaults(Opus.Core.DependencyNode node)
        {
            ...
            {
                throw new Opus.Core.Exception(System.String.Format("Intel C++ include path '{0}' does not exist. Is g++ installed?", cppIncludePath), false);
            }
            ...
            {
                throw new Opus.Core.Exception(System.String.Format("Intel C++ include path '{0}' does not exist. Is g++ installed?", cppIncludePath2), false);
            }
