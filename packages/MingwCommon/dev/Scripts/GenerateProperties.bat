...
%OPUS_DIR%\OpusOptionInterfacePropertyGenerator -i=%OPUS_PACKAGE_DIR%\C\dev\Scripts\ILinkerOptions.cs;%OPUS_PACKAGE_DIR%\MingwCommon\dev\Scripts\ILinkerOptions.cs -o=LinkerOptionProperties.cs -n=MingwCommon -c=LinkerOptionCollection
IF NOT ERRORLEVEL 0 GOTO error
