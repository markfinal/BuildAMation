...
namespace QtCommon
{
    public abstract class Sql : Base
    {
        ...
        {
            options.OutputPaths[C.OutputFileFlags.Executable] = new Opus.Core.StringArray(this.GetModuleDynamicLibrary(this.ToolsetType, target, "QtSql"));
            base.RegisterOutputFiles(options, target, modulePath);
        }

        [C.ExportLinkerOptionsDelegate]
        void QtSql_LinkerOptions(Opus.Core.IModule module, Opus.Core.Target target)
        {
        ...
        void QtSql_VisualCWarningLevel(Opus.Core.IModule module, Opus.Core.Target target)
        {
        ...
        [C.ExportCompilerOptionsDelegate]
        void QtSql_IncludePaths(Opus.Core.IModule module, Opus.Core.Target target)
        {
