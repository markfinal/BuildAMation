...
#region IWriteableNode implementation
        ...
        void IWriteableNode.Write(System.IO.TextWriter writer)
        {
            ...
            {
                writer.WriteLine("\t\t{0} /* {1} */ = {{isa = PBXFileReference; lastKnownFileType = sourcecode.cpp.cpp; path = {2}; sourceTree = SOURCE_ROOT; }};", this.UUID, this.ShortPath, this.RelativePath);
            }
            else
            {
