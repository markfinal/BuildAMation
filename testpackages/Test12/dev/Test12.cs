...
namespace Test12
{
    ...
    class MyOpenGLApplication : C.WindowsApplication
    {
        ...
        class WindowsSourceFiles : C.Cxx.ObjectFileCollection
        {
            ...
            {
                var winSourceDir = this.Locations["PackageDir"].ChildDirectory("source", "win");
        ...
        class UnixSourceFiles : C.Cxx.ObjectFileCollection
        {
            ...
            {
                var unixSourceDir = this.Locations["PackageDir"].ChildDirectory("source", "unix");
        ...
        class OSXSourceFiles : C.Cxx.ObjectFileCollection
        {
            ...
            {
                var osxSourceDir = this.Locations["PackageDir"].ChildDirectory("source", "osx");
